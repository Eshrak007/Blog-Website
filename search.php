    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                $postData="SELECT * FROM posts WHERE title LIKE '%$searchData%' OR description LIKE '%$searchData%'";
                                        ...
                                        <li><i class="fa fa-user"></i>
                                         <?php
                                            ...
                                            while($row=mysqli_fetch_assoc($passshowauther)){
                                                ...
                                                ?>
                                            <?php echo "Author- ". $showauthername; ?>
                                                <?php
                                            }
                                        ?>
                                        </li>
                ...
                <!-- Single Item Blog Post End -->
                        ...
                        echo '<div class="alert alert-info text-center">No Post Found based on your search query.</div>';
                    }
                  }
                  /*search with meta tags start*/
                  else if(isset($_GET['searchtags'])){
                    $searchTags=$_GET['searchtags'];
                    $postData="SELECT * FROM posts WHERE tags LIKE '%$searchTags%'";
                    $postQuery=mysqli_query($con,$postData);
                    $count=mysqli_num_rows($postQuery);
                ...
                <!-- Single Item Blog Post End -->
                        ...
                        echo '<div class="alert alert-info text-center">No Post Found based on this Meta tag" <Strong>'.$searchTag.'"<strong>';
                    }
                  }
                 ?>
